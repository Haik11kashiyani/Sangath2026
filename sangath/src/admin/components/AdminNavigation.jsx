...
export function AdminNavigation({ currentPage, onSelect, onLogout }) {
  const menuItems = [
    { 
      id: 'dashboard', 
      label: 'Dashboard',
      icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
    },
    { 
      id: 'pages', 
      label: 'Pages',
  ...
  return (
    <aside className="sys-sidebar">
      <div className="sys-brand">
        <h2>SANGATH</h2>
        <span className="sys-brand-mono">CORE_PLATFORM_OS</span>
      </div>
      ...
      <button className="sys-btn-outline" onClick={onLogout}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="sys-nav-icon"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
        TERMINATE SESSION
      </button>
    </aside>
  );
